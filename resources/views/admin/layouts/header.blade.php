...
<head>
   ...
   <link rel="stylesheet" href="{{ asset('admin/assets/css/cstmstyle.css') }}">
   @stack('styles')
</head>
                  ...
                  <div class="top-nav-search">
                     ...
                     <form action="#">
                           ...
                           <a class="btn" id="searchdiv"><img
                                 src="{{ asset('admin/assets/img/icons/search.svg') }}" alt="img"></a>
                     </form>
                  </div>
               </li>
               <li class="nav-item dropdown has-arrow flag-nav">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                     <a href="javascript:void(0);" class="dropdown-item">
                           <img src="{{ asset('admin/assets/img/flags/us.png') }}" alt="" height="16">
                           English
                     </a>
                     <a href="javascript:void(0);" class="dropdown-item">
                           <img src="{{ asset('admin/assets/img/flags/fr.png') }}" alt="" height="16">
                           French
                     </a>
                     <a href="javascript:void(0);" class="dropdown-item">
                           <img src="{{ asset('admin/assets/img/flags/es.png') }}" alt="" height="16">
                           Spanish
                     </a>
                     <a href="javascript:void(0);" class="dropdown-item">
                           <img src="{{ asset('admin/assets/img/flags/de.png') }}" alt="" height="16">
                           German
                     </a>
                  </div>
               </li>
                              ...
                              <li class="notification-message">
                                 <a href="activities.html">
                                       <div class="media d-flex">
                                          <span class="avatar flex-shrink-0">
                                             <img alt=""
                                                   src="{{ asset('admin/assets/img/profiles/avatar-06.jpg') }}">
                                          </span>
                                          <div class="media-body flex-grow-1">
               ...
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li class="submenu {{ Request::is('brands*') ? 'show' : '' }}">
                           ...
                           <ul style="{{ Request::is('brands*') ? 'display: block;' : '' }}">
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/product.svg') }}" alt="img"><span>
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/purchase1.svg') }}" alt="img"><span>
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/expense1.svg') }}" alt="img"><span>
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/quotation1.svg') }}" alt="img"><span>
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/transfer1.svg') }}" alt="img"><span>
                     ...
                     <li class="submenu">
                           <a href="javascript:void(0);"><img
                                 src="{{ asset('admin/assets/img/icons/return1.svg') }}" alt="img"><span>
